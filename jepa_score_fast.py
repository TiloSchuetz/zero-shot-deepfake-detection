...
def main(args):
    ...
    assert args.data_folder in ["Imagenet_val", "ForenSynths", "New-Generator"], \
    f"No valid dataset: '{args.data_folder}'"

    if args.data_folder == "Imagenet_val":
        dataset_folder_path = "/ceph/tischuet/"
